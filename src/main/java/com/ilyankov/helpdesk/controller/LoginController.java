...
import com.ilyankov.helpdesk.config.security.JwtProvider;
import com.ilyankov.helpdesk.dto.UserDto;
...
public class LoginController {
	...
	public ResponseEntity<Void> login(@Valid @RequestBody UserDto userDto) {
		...
		String jwtToken = jwtProvider.generationAccessToken(userDto.getEmail());
